use std::{collections::{HashMap, BTreeMap, HashSet}, ops::RangeInclusive};

use crate::types::{Point, MergedRange, IndexedRanges};
...
pub fn build_ranges_by_line(plan: HashMap<Point, Point>, sensors: HashMap<Point, isize>, limits: [isize; 4]) -> IndexedRanges {
    ...
    plan
        ...
        .flat_map(|(sensor, _closest_beacon)| {
            ...
            let ranges =
                sensor_coverage_on_lines(sensor.clone(), *max_distance);
